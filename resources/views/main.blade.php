...
<head>
    ...
    <title>Aplikasi Tata Kelola Kinerja Teknologi Informasi IT</title>

    <link href="{{ asset('style/css/bootstrap-responsive.min.css') }}" rel="stylesheet">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <span class="brand-text font-weight-light">Aplikasi KPI</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <a href="/actionlogout" class="d-block">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="/jawabanPertanyaan" class="nav-link">
                                <i class="nav-icon fas fa-list"></i>
                                <p>
                                    Kuisioner
                                </p>
